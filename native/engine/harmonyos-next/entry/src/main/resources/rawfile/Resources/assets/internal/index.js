System.register("chunks:///_virtual/builtin-pipeline-settings.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './builtin-pipeline-types.ts'], function (exports) {
  var _applyDecoratedDescriptor, _initializerDefineProperty, cclegacy, Camera, CCBoolean, CCInteger, CCFloat, Material, Texture2D, _decorator, Component, rendering, BloomType, fillRequiredPipelineSettings, makePipelineSettings;
  return {
...
System.register("chunks:///_virtual/builtin-pipeline-types.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      let BloomType = exports('BloomType', /*#__PURE__*/function (BloomType) {
...
System.register("chunks:///_virtual/builtin-pipeline.ts", ['cc', './builtin-pipeline-types.ts'], function (exports) {
  var cclegacy, Vec2, Vec4, gfx, Vec3, macro, rendering, assert, renderer, warn, clamp, Material, Layers, PipelineEventType, geometry, sys, pipeline, makePipelineSettings, BloomType;
  return {
    setters: [function (module) {
      cclegacy = module.cclegacy;
      Vec2 = module.Vec2;
    ...
    execute: function () {
      ...
      class BuiltinBloomPassBuilder {
        ...
        configCamera(camera, pipelineConfigs, cameraConfigs) {
          ...
          const hasValidMaterial = bloom.type === BloomType.KawaseDualFilter && !!bloom.kawaseFilterMaterial || bloom.type === BloomType.MipmapFilter && !!bloom.mipmapFilterMaterial;
